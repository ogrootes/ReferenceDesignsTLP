...
---------------------- INPUT FILES --------------------------------------------- 
"IEA-15-240-RWT-NREL_TLP_ElastoDyn.dat"    EDFile         - Name of file containing ElastoDyn input parameters (quoted string)
...
"NREL_15MW_InflowWind.dat" InflowFile      - Name of file containing inflow wind input parameters (quoted string)
...
"NREL_15MW_TLP_SeaState.dat"    SeaStFile   - Name of file containing sea state input parameters (quoted string)
"NREL_15MW_TLP_HydroDyn_updated_version.dat"   HydroFile       - Name of file containing hydrodynamic input parameters (quoted string) 
